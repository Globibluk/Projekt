...
public class SpriteWorld extends JPanel {
	...
	public void paint(Graphics g) {
		...
		if(world.getAsteroid() != null) {
			...
			int aX = sTemp.getX();
			int aY = sTemp.getY();
			int dX = 4 * (sTemp.getXDest() - sTemp.getX());
			int dY = 4 * (sTemp.getYDest() - sTemp.getY());
			g2.drawImage(sTemp.getSprite(), spriteLength * aX - spriteLength / 2, spriteLength
					* aY - spriteLength / 2, sTemp.getSpriteSize() - dX, sTemp.getSpriteSize() - dY, frame);
		}
