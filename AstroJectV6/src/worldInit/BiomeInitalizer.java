	...
	public static void expandWater(int dx, int dy, Cell[][] map) {
		...
		for (int x = 0; x != dx; x++) {
			for (int y = 0; y != dy; y++) {
				...
				if (InitVar.waterProb > World.randM.nextDouble() && map[x][y] == null)
	...
	public static void expandStone(int dx, int dy, Cell[][] map) {
		...
		for (int x = 0; x != dx; x++) {
			for (int y = 0; y != dy; y++) {
				...
				if (InitVar.stoneProb > World.randM.nextDouble() && map[x][y] == null)
	...
	public static void expandSnow(int dx, int dy, Cell[][] map) {
		...
		for (int x = 0; x != dx; x++) {
			for (int y = 0; y != dy; y++) {
				...
				if (InitVar.snowProb > World.randM.nextDouble() && map[x][y] == null)
	...
	public static void expandDirt(int dx, int dy, Cell[][] map) {
		...
		for (int x = 0; x != dx; x++) {
			for (int y = 0; y != dy; y++) {
				...
				if (InitVar.dirtProb > World.randM.nextDouble() && map[x][y] == null)
