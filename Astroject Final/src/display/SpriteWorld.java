...
public class SpriteWorld extends JPanel {
	...
	public void paint(Graphics g) {
		...
		for (int i = 0; i < world.getHList().size(); i++) {
			...
			int decalX = (int) ((world.getHList().get(i).getX() - x) * spriteLength);		// decallage X pour deplacement fluide
			int decalY = (int) ((world.getHList().get(i).getY() - y) * spriteLength);		// decallage Y pour deplacement fluide
		...
		for (int i = 0; i < world.getCList().size(); i++) {
			...
			int decalX = (int) ((world.getCList().get(i).getX() - x) * spriteLength);		// dcallage X pour deplacement fluide
			int decalY = (int) ((world.getCList().get(i).getY() - y) * spriteLength);		// decallage Y pour deplacement fluide
